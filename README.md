...
| Description | Image |
|:-------------|:------|
| **Amazon job post** – searching for engineers to build internal security management platforms. | ![Amazon job post](assets/amazon-job.png) |
| **Stripe job post** – role description mentioning vulnerability management tooling. | ![Stripe job post](assets/stripe-job.png) |
| **LinkedIn conversation** – discussion about working on security platform development. | ![Conversation evidence](assets/security-conversation.png) |
